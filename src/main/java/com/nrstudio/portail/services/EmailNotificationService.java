...
public class EmailNotificationService {
    ...
    private void sendEmail(String destinataire, String sujet, String texteHtml) {
        try {
            ...
            message.setFrom(new InternetAddress(fromEmail, "Portail Client", "UTF-8"));
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(destinataire));
            message.setSubject(sujet, "UTF-8");
            
            message.setContent(texteHtml, "text/html; charset=UTF-8");
...
public void envoyerNotificationInterventionCreee(String destinataire, String reference, String dateIntervention) {
    ...
    // ... garder les autres methodes de test existantes
}